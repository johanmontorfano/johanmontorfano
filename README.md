...
- GCP/Postgresql integration and orchestration at scale.

Over the years, I worked with the following products (non-exhaustive):
- MapBox
- Resend
- GCP, especially Cloud Scheduler, Cloud Jobs, Firestore, Realtime DB, and Authentication.
- Vercel Hosting

On my spare time, I am currently working on: Multi-modal detection of fake content through physics-related incentives.
